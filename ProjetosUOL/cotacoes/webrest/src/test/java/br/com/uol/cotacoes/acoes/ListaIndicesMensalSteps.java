 ...
 */
@Profile("test")
public class ListaIndicesMensalSteps {
    ...
    public void processamos_a_solicitação_de_Lista_de_Indices_Mensal() throws Throwable {
        StringBuilder url = new StringBuilder("/index/interday/list/month?")
    ...
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_da_Lista_de_Indices_Mensal() throws Throwable {
        ...
        String expected = "/**/list({\"prev\":null,\"next\":null,\"docs\":[{\"date\":\"" +
                ...
                oneWeekBefore + "\",\"price\":12558.717,\"exchangeasset\":\"INDX IND\",\"high\":12567.132,\"low\":12558.717,\"open\":12567.132,\"volume\":0,\"close\":12567.022,\"bid\":0,\"ask\":0,\"change\":-8.305,\"pctChange\":-0.07},{\"date\":\"" +
                oneWeekAndOneDayBefore + "\",\"price\":12562.851,\"exchangeasset\":\"INDX IND\",\"high\":12567.132,\"low\":12558.717,\"open\":12567.132,\"volume\":0,\"close\":12567.022,\"bid\":0,\"ask\":0,\"change\":-4.171,\"pctChange\":-0.03},{\"date\":\"" +
                oneMonthBefore + "\",\"price\":12554.574,\"exchangeasset\":\"INDX IND\",\"high\":12567.132,\"low\":12544.605,\"open\":12567.132,\"volume\":0,\"close\":12567.022,\"bid\":0,\"ask\":0,\"change\":-12.448,\"pctChange\":-0.1}]});";
        assertEquals(expected, result);
    }

    @Entao("^deve exibir um JSON dos campos enviados da Lista de Indices Mensal$")
    public void deve_exibir_um_JSON_dos_campos_enviados_da_Lista_de_Indices_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_sem_o_campo_ASKED_campo_deve_ser_ignorado_da_Lista_de_Indices_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
        ...
        String expected = "/**/list({\"prev\":null,\"next\":null,\"docs\":[{\"date\":\"" +
                ...
                oneWeekBefore + "\",\"price\":12558.717,\"exchangeasset\":\"INDX IND\",\"high\":12567.132,\"low\":12558.717,\"open\":12567.132,\"volume\":0,\"close\":12567.022,\"bid\":0,\"change\":-8.305,\"pctChange\":-0.07},{\"date\":\"" +
                oneWeekAndOneDayBefore + "\",\"price\":12562.851,\"exchangeasset\":\"INDX IND\",\"high\":12567.132,\"low\":12558.717,\"open\":12567.132,\"volume\":0,\"close\":12567.022,\"bid\":0,\"change\":-4.171,\"pctChange\":-0.03},{\"date\":\"" +
                oneMonthBefore + "\",\"price\":12554.574,\"exchangeasset\":\"INDX IND\",\"high\":12567.132,\"low\":12544.605,\"open\":12567.132,\"volume\":0,\"close\":12567.022,\"bid\":0,\"change\":-12.448,\"pctChange\":-0.1}]});";
        assertEquals(expected, result);
    }

    @Entao("^deve exibir um CSV contendo os campos enviados da Lista de Indices Mensal$")
    public void deve_exibir_um_CSV_contendo_os_campos_enviados_da_Lista_de_Indices_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_um_CSV_dos_campos_enviados_sem_o_campo_ASKED_campo_deve_ser_ignorado_da_Lista_de_Indices_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_um_JSON_dos_campos_enviados_sem_o_campo_ASKED_campo_deve_ser_ignorado_da_Lista_de_Indices_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Indices_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_um_CSV_contendo_os_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Indices_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_um_JSON_dos_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Indices_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
