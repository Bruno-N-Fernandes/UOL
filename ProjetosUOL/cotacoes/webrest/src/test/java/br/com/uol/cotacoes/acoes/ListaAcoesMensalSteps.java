 ...
 */
@Profile("test")
public class ListaAcoesMensalSteps {
    ...
    @Quando("^for processada a solicitação de Lista de Ações Mensal$")
    public void for_processada_a_solicitação_de_Lista_de_Ações_Mensal() throws Throwable {
        StringBuilder url = new StringBuilder("/asset/interday/list/month?")
    ...
    @Entao("^deve exibir uma Lista de Ações Mensal com a funcao de callback contendo o JSON dos campos enviados$")
    public void deve_exibir_uma_Lista_de_Ações_Mensal_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados() throws Throwable {
    ...
    @Entao("^deve exibir um JSON dos campos enviados da Lista de Ações Mensal$")
    public void deve_exibir_um_JSON_dos_campos_enviados_da_Lista_de_Ações_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir uma lista com a funcao de callback contendo o JSON dos campos enviados sem o campo ASKED \\(campo deve ser ignorado\\) da Lista de Ações Mensal$")
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_sem_o_campo_ASKED_campo_deve_ser_ignorado_da_Lista_de_Ações_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
        ...
        String expected = "/**/list({\"prev\":null,\"next\":null,\"docs\":[{\"date\":\"" +
                ...
                oneMonthBefore +
                "\",\"price\":5.78,\"exchangeasset\":\"COTEMINAS PN    \",\"high\":5.78,\"low\":5.69,\"open\":5.69,\"volume\":15100,\"close\":5.78,\"bid\":5.65,\"change\":0,\"pctChange\":0}]});";
        assertEquals(expected, result);
    }

    @Entao("^deve exibir um CSV contendo os campos enviados da Lista de Ações Mensal$")
    public void deve_exibir_um_CSV_contendo_os_campos_enviados_da_Lista_de_Ações_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir um CSV dos campos enviados sem o campo ASKED \\(campo deve ser ignorado\\) da Lista de Ações Mensal$")
    public void deve_exibir_um_CSV_dos_campos_enviados_sem_o_campo_ASKED_campo_deve_ser_ignorado_da_Lista_de_Ações_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir um JSON dos campos enviados sem o campo ASKED \\(campo deve ser ignorado\\) da Lista de Ações Mensal$")
    public void deve_exibir_um_JSON_dos_campos_enviados_sem_o_campo_ASKED_campo_deve_ser_ignorado_da_Lista_de_Ações_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir uma lista com a funcao de callback contendo o JSON dos campos enviados com novo valor no topo da Lista de Ações Mensal$")
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Ações_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir um CSV contendo os campos enviados com novo valor no topo da Lista de Ações Mensal$")
    public void deve_exibir_um_CSV_contendo_os_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Ações_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir um JSON dos campos enviados com novo valor no topo da Lista de Ações Mensal$")
    public void deve_exibir_um_JSON_dos_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Ações_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
