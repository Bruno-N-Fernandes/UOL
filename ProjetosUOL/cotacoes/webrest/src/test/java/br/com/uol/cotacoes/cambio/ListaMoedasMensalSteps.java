...
/**
 * Created by vrx_mtoledo on 05/06/17.
 */
@Profile("test")
public class ListaMoedasMensalSteps {
    ...
    public void for_processada_a_solicitação_de_Lista_de_Moedas_Mensal() throws Throwable {
        String url = "/currency/interday/list/month?"
    ...
    public void deve_exibir_uma_Lista_de_Moedas_Mensal_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados() throws Throwable {
    ...
    public void deve_exibir_um_JSON_dos_campos_enviados_da_Lista_de_Moedas_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_sem_o_campo_DATA_campo_deve_ser_ignorado_da_Lista_de_Moedas_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_um_CSV_contendo_os_campos_enviados_da_Lista_de_Moedas_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_um_CSV_dos_campos_enviados_sem_o_campo_DATA_campo_deve_ser_ignorado_da_Lista_de_Moedas_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_um_JSON_dos_campos_enviados_sem_o_campo_DATA_campo_deve_ser_ignorado_da_Lista_de_Moedas_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Moedas_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_um_CSV_contendo_os_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Moedas_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    public void deve_exibir_um_JSON_dos_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Moedas_Mensal() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
