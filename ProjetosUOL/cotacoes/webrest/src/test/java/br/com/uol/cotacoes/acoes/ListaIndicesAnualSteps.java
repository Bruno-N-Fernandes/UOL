 ...
 */
@Profile("test")
public class ListaIndicesAnualSteps {
    ...
    @Quando("^processamos a solicitação de Lista de Indices Anual$")
    public void processamos_a_solicitação_de_Lista_de_Indices_Anual() throws Throwable {
        StringBuilder url = new StringBuilder("/index/interday/list/year?")
    ...
    @Entao("^deve exibir uma lista com a funcao de callback contendo o JSON dos campos enviados da Lista de Indices Anual$")
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_da_Lista_de_Indices_Anual() throws Throwable {
        ...
        String expected = "/**/list({\"prev\":null,\"next\":null,\"docs\":[{\"date\":\"" +
                ...
                threeMonthsBefore +
                "\",\"price\":12527.167,\"exchangeasset\":\"INDX IND\",\"high\":12542.208,\"low\":12465.031,\"open\":12485.535,\"volume\":0,\"close\":12485.77,\"bid\":0,\"ask\":0,\"change\":41.398,\"pctChange\":0.33},{\"date\":\"" +
    ...
    @Entao("^deve exibir uma lista com a funcao de callback contendo o JSON dos campos enviados com novo valor no topo da Lista de Indices Anual$")
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Indices_Anual() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir um JSON dos campos enviados da Lista de Indices Anual$")
    public void deve_exibir_um_JSON_dos_campos_enviados_da_Lista_de_Indices_Anual() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir uma lista com a funcao de callback contendo o JSON dos campos enviados sem o campo ASKED \\(campo deve ser ignorado\\) da Lista de Indices Anual$")
    public void deve_exibir_uma_lista_com_a_funcao_de_callback_contendo_o_JSON_dos_campos_enviados_sem_o_campo_ASKED_campo_deve_ser_ignorado_da_Lista_de_Indices_Anual() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
        ...
        String expected = "/**/list({\"prev\":null,\"next\":null,\"docs\":[{\"date\":\"" +
                ...
                threeMonthsBefore +
                "\",\"price\":12527.167,\"exchangeasset\":\"INDX IND\",\"high\":12542.208,\"low\":12465.031,\"open\":12485.535,\"volume\":0,\"close\":12485.77,\"bid\":0,\"change\":41.398,\"pctChange\":0.33},{\"date\":\"" +
                threeMonthsAndOneDayBefore +
                "\",\"price\":12527.167,\"exchangeasset\":\"INDX IND\",\"high\":12542.208,\"low\":12465.031,\"open\":12485.535,\"volume\":0,\"close\":12485.77,\"bid\":0,\"change\":41.398,\"pctChange\":0.33},{\"date\":\"" +
                oneYearBefore +
    ...
    @Entao("^deve exibir um CSV contendo os campos enviados da Lista de Indices Anual$")
    public void deve_exibir_um_CSV_contendo_os_campos_enviados_da_Lista_de_Indices_Anual() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir um CSV contendo os campos enviados com novo valor no topo da Lista de Indices Anual$")
    public void deve_exibir_um_CSV_contendo_os_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Indices_Anual() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir um CSV dos campos enviados sem o campo ASKED \\(campo deve ser ignorado\\) da Lista de Indices Anual$")
    public void deve_exibir_um_CSV_dos_campos_enviados_sem_o_campo_ASKED_campo_deve_ser_ignorado_da_Lista_de_Indices_Anual() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
    ...
    @Entao("^deve exibir um JSON dos campos enviados com novo valor no topo da Lista de Indices Anual$")
    public void deve_exibir_um_JSON_dos_campos_enviados_com_novo_valor_no_topo_da_Lista_de_Indices_Anual() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
        ...
        String expected = "{\"prev\":null,\"next\":null,\"docs\":[{\"date\":\"" +
                ...
                "\",\"price\":12527.167,\"exchangeasset\":\"INDX IND\",\"high\":12542.208,\"low\":12465.031,\"open\":12485.535,\"volume\":0,\"close\":12485.77,\"bid\":0,\"ask\":0,\"change\":41.398,\"pctChange\":0.33},{\"date\":\"" +
                oneYearBefore +
                "\",\"price\":12527.167,\"exchangeasset\":\"INDX IND\",\"high\":12542.208,\"low\":12465.031,\"open\":12485.535,\"volume\":0,\"close\":12485.77,\"bid\":0,\"ask\":0,\"change\":41.398,\"pctChange\":0.33}]}";        assertEquals(expected, result);
    }

    @Entao("^deve exibir um JSON dos campos enviados sem o campo ASKED \\(campo deve ser ignorado\\) da Lista de Indices Anual$")
    public void deve_exibir_um_JSON_dos_campos_enviados_sem_o_campo_ASKED_campo_deve_ser_ignorado_da_Lista_de_Indices_Anual() throws Throwable {
        String result = contextTest.getResultActions()
                .andExpect(status().isOk())
                .andReturn().getResponse().getContentAsString();
