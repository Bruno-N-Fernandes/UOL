...
Funcionalidade: ListaCommoditiesHojePaginada

  Cenario: Solicitar todos os dados de commodities na data atual para formato JSON para o serviço de Lista de Commodities de Hoje Paginada
  ...
  Cenario: Solicitar todos os dados de commodities na data atual para formato JSON sem parâmetro campos
    ...
    E que enviamos o item 1163
    Quando processamos a solicitação de Lista Commodities Hoje Paginada
    Entao deve exibir mensagem de erro com status "500" e causa "Parameter conditions \"item, fields, size\" OR \"item, fields, size, next\" OR \"item, fields, size, prev\" not met for actual request parameters: format={json}, item={1163}, size={5}"}"

  Cenario: Solicitar todos os dados de commodities na data atual para formato JSON sem parâmetro tamanho
    Dado que enviamos o formato "json"
    E que enviamos o item 1163
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista Commodities Hoje Paginada
    Entao deve exibir mensagem de erro com status "500" e causa "Parameter conditions \"item, fields, size\" OR \"item, fields, size, next\" OR \"item, fields, size, prev\" not met for actual request parameters: format={json}, item={1163}, fields={date,price,exchangeasset,high,low,open,volume,close,bid,ask,change,pctChange}"}"
  ...
  Cenario: Solicitar todos os dados de commodities na data atual para formato JSONP para o serviço de Lista de Commodities de Hoje Paginada
  ...
  Cenario: Solicitar todos os dados de commodities na data atual para formato JSONP sem parâmetro campos
    ...
    E que enviamos o tamanho 5
    Quando processamos a solicitação de Lista Commodities Hoje Paginada
    Entao deve exibir mensagem de erro com status "500" e causa "Parameter conditions \"item, fields, size\" OR \"item, fields, size, next\" OR \"item, fields, size, prev\" not met for actual request parameters: jsonp={callback}, item={1163}, size={5}"}"
  ...
  Cenario: Avançar proxima pag. a partir da 1ª pag. no serviço de Lista Commodities Hoje Paginada JSONP
 # Criar a Primeira Pagina
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 1163
    E que enviamos o tamanho 2
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista Commodities Hoje para a Primeira Página
  ...
  Cenario: Avançar proxima pag. novamente a partir de outra pag. no serviço de Lista Commodities Hoje Paginada JSONP
    # Criar a Primeira Pagina
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 1163
    E que enviamos o tamanho 2
    ...
    E que enviamos o ponteiro next com valor "x"
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista Commodities Hoje para a Próxima Página
    E mantemos o valor do next gerado para a proxima pagina
  ...
  Cenario: Avançar proxima pag. a partir da 1ª pag. no serviço de Lista Commodities Hoje Paginada JSON
 # Criar a Primeira Pagina
    Dado que enviamos o formato "json"
    E que enviamos o item 1163
    E que enviamos o tamanho 2
  ...
  Cenario: Avançar proxima pag. novamente a partir de outra pag. no serviço de Lista Commodities Hoje Paginada JSON
    # Criar a Primeira Pagina
    Dado que enviamos o formato "json"
    E que enviamos o item 1163
    E que enviamos o tamanho 2
  ...
  Cenario: Voltar a pag. anterior a partir da última pag. no serviço de Lista Commodities Hoje Paginada JSONP
    # Acessar Última Pagina
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 1163
    E que enviamos o tamanho 2
    E que enviamos o ponteiro next com valor fixo "145884079N"
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista Commodities Hoje para a Última Página
  ...
  Cenario: Voltar a pag. anterior novamente a partir de outra pag. no serviço de Lista Commodities Hoje Paginada JSONP
    # Acessar Última Pagina
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 1163
    E que enviamos o tamanho 2
    ...
    E que enviamos o ponteiro prev com valor "x"
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista Commodities Hoje para a Página Anterior
    E mantemos o valor do prev gerado para a pagina anterior
  ...
  Cenario: Voltar a pag. anterior a partir da última pag. no serviço de Lista Commodities Hoje Paginada JSON
    # Acessar Última Pagina
    Dado que enviamos o formato "json"
    E que enviamos o item 1163
    E que enviamos o tamanho 2
  ...
  Cenario: Voltar a pag. anterior novamente a partir de outra pag. no serviço de Lista Commodities Hoje Paginada JSON
    # Acessar Última Pagina
    Dado que enviamos o formato "json"
    E que enviamos o item 1163
    E que enviamos o tamanho 2
