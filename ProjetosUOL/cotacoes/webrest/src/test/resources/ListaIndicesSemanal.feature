...
Funcionalidade: ListaIndicesSemanal

  Contexto: Limpar todos os parâmetros do contexto

##  Scenario 01:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSONP
...
#  Scenario 02:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSONP após inclusão de novos valores
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 10
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista de Indices Semanal
...
#  Scenario 03:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSONP sem parâmetro campos
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 10
    Quando processamos a solicitação de Lista de Indices Semanal
...
##  Scenario 04:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSONP sem parâmetro indice
    Dado que enviamos o formato JSONP "list"
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista de Indices Semanal
...
##  Scenario 05:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSON sem parâmetro JSONP
...
##  Scenario 06:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSONP com um campo inválido
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 10
...
#  Scenario 07:
  Cenario: Solicitar todos os dados de um indice na semana para formato CSV
...
#  Scenario 08:
  Cenario: Solicitar todos os dados de um indice na semana para formato CSV após inclusão de novos valores
    Dado que enviamos o formato "csv"
    E que enviamos o item 10
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista de Indices Semanal
...
#  Scenario 09:
  Cenario: Solicitar todos os dados de um indice na semana para formato CSV sem parâmetro campos
    Dado que enviamos o formato "csv"
    E que enviamos o item 10
    Quando processamos a solicitação de Lista de Indices Semanal
    Entao deve exibir mensagem de erro com status "400" e causa "Required String parameter 'fields' is not present"
...
#  Scenario 10:
  Cenario: Solicitar todos os dados de um indice na semana para formato CSV sem parâmetro indice
    Dado que enviamos o formato "csv"
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista de Indices Semanal
    Entao deve exibir mensagem de erro com status "400" e causa "Required Integer parameter 'item' is not present"
...
#  Scenario 11:
  Cenario: Solicitar todos os dados de um indice na semana para formato CSV com um campo inválido
    Dado que enviamos o formato "csv"
    E que enviamos o item 10
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ASKED", "change" e "pctChange"
    Quando processamos a solicitação de Lista de Indices Semanal
...
#  Scenario 12:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSON
    Dado que enviamos o item 10
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista de Indices Semanal
    Entao deve exibir um JSON dos campos enviados da Lista de Indices da Semana
...
#  Scenario 13:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSON após inclusão de novos valores
    Dado que enviamos o item 10
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista de Indices Semanal
    E que incluimos novos valores para o item 10 para um dia mais recente
...
#  Scenario 14:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSON sem parâmetro campos
    Dado que enviamos o item 10
    Quando processamos a solicitação de Lista de Indices Semanal
    Entao deve exibir mensagem de erro com status "400" e causa "Required String parameter 'fields' is not present"

#  Scenario 15:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSON sem parâmetro indice
    Dado que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista de Indices Semanal
    Entao deve exibir mensagem de erro com status "400" e causa "Required Integer parameter 'item' is not present"

#  Scenario 16:
  Cenario: Solicitar todos os dados de um indice na semana para formato JSON com um campo inválido
    Dado que enviamos o item 10
  	E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ASKED", "change" e "pctChange"
    Quando processamos a solicitação de Lista de Indices Semanal
