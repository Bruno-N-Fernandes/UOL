...
Funcionalidade: ListaAcoesHojePaginada

  Cenario: Solicitar todos os dados de acoes na data atual para formato JSON para o serviço de Lista de Acoes de Hoje Paginada
  ...
  Cenario: Solicitar todos os dados de acoes na data atual para formato JSON sem parâmetro item
    Dado que enviamos o formato "json"
    E que enviamos o tamanho 5
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista Acao Hoje Paginada
    Entao deve exibir mensagem de erro com status "500" e causa "\"item, fields, size\" OR \"item, fields, size, next\" OR \"item, fields, size, prev\" not met for actual request parameters: format={json}, fields={date,price,exchangeasset,high,low,open,volume,close,bid,ask,change,pctChange}, size={5}"

  Cenario: Solicitar todos os dados de acoes na data atual para formato JSON sem parâmetro campos
    Dado que enviamos o formato "json"
    E que enviamos o tamanho 5
    E que enviamos o item 232
    Quando processamos a solicitação de Lista Acao Hoje Paginada
    Entao deve exibir mensagem de erro com status "500" e causa "Parameter conditions \"item, fields, size\" OR \"item, fields, size, next\" OR \"item, fields, size, prev\" not met for actual request parameters: format={json}, item={232}, size={5}"

  Cenario: Solicitar todos os dados de acoes na data atual para formato JSON sem parâmetro tamanho
    Dado que enviamos o formato "json"
    E que enviamos o item 232
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista Acao Hoje Paginada
    Entao deve exibir mensagem de erro com status "500" e causa "\"item, fields, size\" OR \"item, fields, size, next\" OR \"item, fields, size, prev\" not met for actual request parameters: format={json}, item={232}, fields={date,price,exchangeasset,high,low,open,volume,close,bid,ask,change,pctChange}"

  Cenario: Solicitar todos os dados de acoes na data atual para formato JSON com um campo inválido
    Dado que enviamos o formato "json"
    E que enviamos o item 232
    E que enviamos o tamanho 5
  ...
  Cenario: Solicitar todos os dados de acoes na data atual para formato JSONP para o serviço de Lista de Acoes de Hoje Paginada
  ...
  Cenario: Solicitar todos os dados de acoes na data atual para formato JSONP sem parâmetro campos
    Dado que enviamos o formato JSONP "callback"
    E que enviamos o item 232
    E que enviamos o tamanho 5
    Quando processamos a solicitação de Lista Acao Hoje Paginada
    Entao deve exibir mensagem de erro com status "500" e causa "Parameter conditions \"item, fields, size\" OR \"item, fields, size, next\" OR \"item, fields, size, prev\" not met for actual request parameters: jsonp={callback}, item={232}, size={5}"}"

  Cenario: Solicitar todos os dados de acoes na data atual para formato JSONP sem parâmetro item
    Dado que enviamos o formato JSONP "callback"
    E que enviamos o tamanho 5
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista Acao Hoje Paginada
  ...
  Cenario: Solicitar todos os dados de acoes na data atual para formato JSONP com um campo inválido
    Dado que enviamos o formato JSONP "callback"
    E que enviamos o item 232
    E que enviamos o tamanho 5
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "CHANGED" e "pctChange"
  ...
  Cenario: Avançar proxima pag. a partir da 1ª pag. no serviço de Lista Acao Hoje Paginada JSONP
 # Criar a Primeira Pagina
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 232
    E que enviamos o tamanho 2
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"    
    E processamos a solicitação de Lista Acao Hoje para a Primeira Página
  ...
  Cenario: Avançar proxima pag. novamente a partir de outra pag. no serviço de Lista Acao Hoje Paginada JSONP
  # Criar a Primeira Pagina
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 232
    E que enviamos o tamanho 2
  ...
  # Avancar Proxima Pagina
    ...
    E que enviamos o ponteiro next com valor "x"
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista Acao Hoje para a Próxima Página
    E mantemos o valor do next gerado para a proxima pagina

  # Avancar Proxima Novamente
    E que enviamos o formato JSONP "list"
    E que enviamos o item 232
    E que enviamos o tamanho 2
    E que enviamos o ponteiro next com valor "x"
 ...
 Cenario: Avançar proxima pag. a partir da 1ª pag. e após inclusao de novos valores retornar no serviço de Lista Acao Hoje Paginada JSONP
  # Criar a Primeira Pagina
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 232
    E que enviamos o tamanho 2
  ...
  # Incluir novos valores
  	E que incluímos novos valores para essa ação no mesmo dia
  ...
  # Retornar a Pagina Anterior 
    ...
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista Acao Hoje para a Página Anterior
  	E mantemos o valor do prev gerado para a pagina anterior 
  ...
  Cenario: Avançar proxima pag. a partir da 1ª pag. no serviço de Lista Acao Hoje Paginada JSON
 # Criar a Primeira Pagina
    Dado que enviamos o formato "json"
    E que enviamos o item 232
    E que enviamos o tamanho 2
  ...
  Cenario: Avançar proxima pag. a partir da 1ª pag. e após inclusao de novos valores retornar no serviço de Lista Acao Hoje Paginada JSON
  # Criar a Primeira Pagina
    Dado que enviamos o formato "json"
    E que enviamos o item 232
    E que enviamos o tamanho 2
  ...
  Cenario: Avançar proxima pag. novamente a partir de outra pag. no serviço de Lista Acao Hoje Paginada JSON
  # Criar a Primeira Pagina
    Dado que enviamos o formato "json"
    E que enviamos o item 232
    E que enviamos o tamanho 2
  ...
  Cenario: Voltar a pag. anterior a partir da última pag. no serviço de Lista Acao Hoje Paginada JSONP
  # Acessar Última Pagina
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 232
    E que enviamos o tamanho 2
    E que enviamos o ponteiro next com valor fixo "160830767N"
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    E processamos a solicitação de Lista Acao Hoje para a Última Página
    E mantemos o valor do prev gerado para a pagina anterior
  ...
  # Voltar Pagina Anterior
    ...
    E que enviamos os campos: "date", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista Acao Hoje para a Página Anterior
  ...
  Cenario: Voltar a pag. anterior novamente a partir de outra pag. no serviço de Lista Acao Hoje Paginada JSONP
  # Acessar Última Pagina
    Dado que enviamos o formato JSONP "list"
    E que enviamos o item 232
    E que enviamos o tamanho 2
  ...
  Cenario: Voltar a pag. anterior a partir da última pag. no serviço de Lista Acao Hoje Paginada JSON
  # Acessar Última Pagina
    Dado que enviamos o formato "json"
    E que enviamos o item 232
    E que enviamos o tamanho 2
  ...
  Cenario: Voltar a pag. anterior novamente a partir de outra pag. no serviço de Lista Acao Hoje Paginada JSON
  # Acessar Última Pagina
    Dado que enviamos o formato "json"
    E que enviamos o item 232
    E que enviamos o tamanho 2
