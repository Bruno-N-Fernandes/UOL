...
Funcionalidade: ListaAcoesHoje

#  1
  Cenario: Solicitar todos os dados de acoes na data atual para formato JSON
...
#    5
  Cenario: Solicitar todos os dados de acoes na data atual para formato CSV
...
#    6
  Cenario: Solicitar todos os dados de acoes na data atual para formato CSV sem parâmetro item
    Dado que enviamos o formato "csv"
    E que enviamos os campos: "id", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "change" e "pctChange"
    Quando processamos a solicitação de Lista Acao Hoje
    Entao deve exibir mensagem de erro com status "500" e causa "Parameter conditions \"item, fields\" not met for actual request parameters:"
...
#    7
  Cenario: Solicitar todos os dados de acoes na data atual para formato CSV sem parâmetro campos
    Dado que enviamos o formato "csv"
    E que enviamos o item 232
    Quando processamos a solicitação de Lista Acao Hoje
    Entao deve exibir mensagem de erro com status "500" e causa "Parameter conditions \"item, fields\" not met for actual request parameters:"
...
#    8
  Cenario: Solicitar todos os dados de acoes na data atual para formato CSV com um campo inválido
    Dado que enviamos o formato "csv"
    E que enviamos o item 232
    E que enviamos os campos: "id", "price", "exchangeasset", "high", "low", "open", "volume", "close","bid", "ask", "CHANGED" e "pctChange"
    Quando processamos a solicitação de Lista Acao Hoje
...
#    9
  Cenario: Solicitar todos os dados de acoes na data atual para formato JSONP
